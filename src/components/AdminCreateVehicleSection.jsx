...
export default function AdminCreateVehicleSection() {
  ...
  return (
    <section id="admin-create-section" className="admin-section-block">
      <Container>
        <Card className="admin-section-card border-0">
          <Card.Body className="p-4 p-md-5">
            <div className="mb-4">
              <h2 className="fw-bold mb-1">Crea nuovo veicolo</h2>
              <p className="text-muted mb-0">
                Inserisci tutti i dati del nuovo veicolo.
              </p>
            </div>
                        ...
                        <div className="admin-checkbox-list">
                          {optionals.map((optional) => (
                            <Form.Check
                              ...
                              label={optional.name}
                              checked={formData.optionalIds.includes(
                                optional.id,
                              )}
                              onChange={(e) =>
